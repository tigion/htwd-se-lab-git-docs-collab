...
. Speichern sie die Datei _demo-diagramme.adoc_ und lassen Sie sich die
...
. Bearbeiten Sie die Datei _demo-diagramme.adoc_ und ergänzen Sie obiges
...
. Überprüfen Sie das Ergebnis Ihrer _demo-diagramme.adoc_ in der Vorschau
  des AsciiDoc-Dokuments.


==== Aufgabe 1.2 - Klassendiagramm

. Erweitern Sie die Datei _demo-diagramme.adoc_ um ein *Klassendiagramm*.

==== Aufgabe 1.3 - C4 Model Context Diagramm

. Erweitern Sie die Datei _demo-diagramme.adoc_ um ein *C4 Model Context (Level
  1) Diagramm*.

==== Aufgabe 1.4 - C4 Model Container Diagramm

. Erweitern Sie die Datei _demo-diagramme.adoc_ um ein *C4 Model Container
  (Level 2) Diagramm*.
