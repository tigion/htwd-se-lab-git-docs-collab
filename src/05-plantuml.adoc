...
- Verwenden von PlantUML Diagrammen in AsciiDoc-Dokumenten
- Diagrammtypen: UML-Klassendiagramme, C4-Modell Level 1 und 2
****
...
Es empfiehlt sich, die generierten Grafiken nicht ins Repository aufnehmen, da
diese jederzeit neu generiert werden können.
...
====
=====
Es gibt noch eine alternative Möglichkeit Diagramme als Block Macro einzubinden.
...
Im Abschnitt <<extras,Extras>> findet man Hinweise zu den benötigten
...
====
=====
* In der Regel definiert man erste die Elemente (Type, Bezeichnung) und
...
* Die Hintergrundfarbe von Elemente kann durch Angabe eine Hexadezimalwertes
...
[NOTE]
====
Mit dieser Erweiterung können PlanUML-Dateien direkt in Visual Studio Code
...
. Erweitern Sie die Datei _diagramme-mit-plantuml.adoc_ um ein *Klassendiagramm*.

==== Aufgabe 1.3 - C4 Model Context Diagramm

. Erweitern Sie die Datei _diagramme-mit-plantuml.adoc_ um ein *C4 Model Context (Level
  1) Diagramm*.

==== Aufgabe 1.4 - C4 Model Container Diagramm

. Erweitern Sie die Datei _diagramme-mit-plantuml.adoc_ um ein *C4 Model Container
  (Level 2) Diagramm*.
