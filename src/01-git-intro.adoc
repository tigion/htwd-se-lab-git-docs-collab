...
.Lernziele
****
* Einrichtung und Kennenlernen der Grundlagen zur Nutzung von *GitHub*, *Git*,
und *Visual Studio Code*
* Anlegen eines ersten Dokumentes mit *AsciiDoc*-Syntax.
* Anwenden eines einfachen *Git-Workflows* zur Versionierung von Änderungen an einem Projekt
****
...
==== Aufgabe 3.2 - Versionierung mit Git
