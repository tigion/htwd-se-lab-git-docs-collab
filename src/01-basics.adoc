...
1. Erstellen Sie ein neues Repository mit folgenden Einstellungen:
...
. Passen Sie die Datei *_README.md_* auf GitHub mit folgendem Inhalt an:
+
.README.md
[source,markdown]
----
...
Es dient als Spielwiese für die Bearbeitung der Aufgaben, um die Grundlagen der
Versionsverwaltung mit Git, die Dokumentation mit AsciiDoc und den Umgang mit
GitHub kennenzulernen.

- **Git**, **GitHub** und **AsciiDoc**
----
...
. Nehmen Sie die Änderung mit kbd:[Commit changes...] als neue Version in das Repository auf.
...
Repository *htwd-se-example-project* in Ihr Studentenlaufwerk, bspw. unter
`U:\praktika\se\`, oder an geeigneter Stelle lokal auf Ihren Rechner.
...
Dafür gibt es die Möglichkeit, eine Datei _.gitignore_ im Repository anzulegen, in
welcher alle Dateien, Verzeichnisse und Dateitypen festgelegt werden, welche Git
ignorieren soll.

[IMPORTANT]
====
Die Datei _.gitignore_ muss in Ihr Repository aufgenommen werden, damit Sie für jeden der Mitwirkenden gilt.
====
...
Rechner, müssen Sie, falls noch nicht vorhanden, mindestens *Git* und *Visual
Studio Code* samt *AsciiDoc-Erweiterung* installieren. Beachten Sie hierzu auch
die Hinweise im Praktikum.
...
link:install-and-config/[Installation & Konfiguration].
