...
.⚠️ Check-Liste für die Praktika in den Windows-Laboren
[%collapsible]
====
=====
...
- [x] benötigtes Projekt-Repository in GitHub geöffnet
- [x] _.gitconfig_ wiederhergestellt (`C:\Users\<username>\.gitconfig`)
- [x] AsciiDoc-Erweiterung in VS Code installiert
- [x] benötigtes Projekt in VS Code als Ordner geöffnet
****
